...
class ArticalController extends Controller
{
    ...
    {
        $id = Auth::id();
        $Artical = Artical::where('language_id',2)->where('author_id',$id)->latest()->paginate(5);
        return view('author.articals.index')->with([
            'articals' => $Artical
        ]);
    }
    ...
    public function create()
    {
        try{
            ...
            return response()->json([
                "success" => true,
                "html" => view('author.articals.ajax.create',compact('categoriesd'))->render(),
            ]);
        }
        catch(\Exception $ex){
            return response()->json([
    ...
    public function edit($id)
    {
        try {
            ...
            return response()->json([
                "success" => true,
                "html" => view('author.articals.ajax.edit')->with([
                    'artical' => $artical,
