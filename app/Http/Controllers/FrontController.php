...
class FrontController extends Controller
{
   ...
   public function index()
   {
      ...
      // } 
      // $Artical = Artical::where('language_id',2)->latest()->paginate(5);
      ...
      $articalone = Artical::where('status', 'active')->where('aproved', 'active')->orderBy('created_at', 'desc')->first();
      ...
      $articalhindione = Artical::with('user')->where('status', 'active')->where('aproved', 'active')->where('language_id', '1')->orderBy('created_at', 'desc')->first();
      ...
      $articalhindicount = Artical::where('language_id', '1')->count();
   ...
   public function articals($slug)
   {
      ...
      $articaldetails = Artical::with('user', 'category', 'comment')->where('status', 'active')->where('url', $slug)->first();
      ...
      $relatedarticals = Artical::with('user')->where('status', 'active')->where('title', 'LIKE', '%' . $articaldetails->title . '%')->get();
   ...
   public function urduartical()
   {
      ...
      $featureArticles = Artical::where('status', 'active')->where('aproved', 'active')->where('language_id', '3')->orderBy('viewd', 'desc')->limit(11)->get();
   ...
   public function arbicartical()
   {
      ...
      $articalarbics = Artical::with('user')->where('status', 'active')->where('aproved', 'active')->where('language_id', '4')->orderBy('created_at', 'desc')->paginate(11);
   ...
   public function englishartical()
   {
      ...
      $englisharticals = Artical::with('user')->where('status', 'active')->where('aproved', 'active')->where('language_id', '2')->orderBy('created_at', 'desc')->paginate(11);
      $mustView = Artical::where('status', 'active')->where('aproved', 'active')->where('language_id', '2')->orderBy('viewd', 'desc')->first();
   ...
   public function hindihartical()
   {
      ...
      $hindiharticals = Artical::with('user')->where('status', 'active')->where('aproved', 'active')->where('language_id', '1')->orderBy('created_at', 'desc')->paginate(11);
   ...
   public function allartical()
   {
      ...
      $ads01 = Add::first();
      $allarticals = Artical::with('user')->where('status', 'active')->where('aproved', 'active')->orderBy('created_at', 'desc')->get();
   ...
   {
      $allauthors = User::with('articals')->orderBy('created_at', 'desc')->paginate(12);
      $ads01 = Add::first();
      $mustView = Artical::where('status', 'active')->where('aproved', 'active')->orderBy('viewd', 'desc')->first();
   ...
   public function authorlistingall($name)
   {
      ...
      $author_id = $users->id;
      $ads01 = Add::first();
      $authorlistingalls = Artical::with('user')->where('author_id', $author_id)->where('aproved', 'active')->where('status', 'active')->orderBy('created_at', 'desc')->paginate(5);
      ...
      $category_id  = collect($category_ids)->unique();
      $categorylis = Category::whereIn('id', $category_id)->get();
      $mustPop = Artical::where('status', 'active')->where('aproved', 'active')->orderBy('viewd', 'desc')->first();
      foreach ($categorylis as $categoryli) {
         $categorylis->articals = Artical::where('author_id', $author_id)->where('category_id', $categoryli->id)->get();
      }
      //return view('frontend.author_listing',compact('authorlistingalls','users'));
      return view('frontend.authordetails', compact(
         'authorlistingalls',
         'users',
         'authorlistcount',
         'authorbookcount',
