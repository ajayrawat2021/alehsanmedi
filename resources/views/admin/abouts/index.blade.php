...
<a href="javascript:void(0)" class="edit-abouts text-dark mr-2" about_id="{{ $about->id }}" title="Edit banner"><i class="fa fa-pencil" aria-hidden="true"></i></a>

<a href="javascript:void(0)" onclick="deleteConfirmation({{ $about->id }})" class="text-danger" title="Delete"><i class="fa fa-trash" aria-hidden="true" ></i></a>
