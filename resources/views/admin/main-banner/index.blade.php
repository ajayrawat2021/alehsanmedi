...
<a href="javascript:void(0)" class="edit-banner text-dark mr-2" banner_id="{{ $banner->id }}" title="Edit banner"><i class="fa fa-pencil" aria-hidden="true"></i></a>

<a href="javascript:void(0)" onclick="deleteConfirmation({{ $banner->id }})" class="text-danger" title="Delete"><i class="fa fa-trash" aria-hidden="true" ></i></a>
