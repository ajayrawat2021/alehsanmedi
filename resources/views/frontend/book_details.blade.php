            ...
            <table class="table table-bordered table-striped mb-4">
              ...
              @if($bookdetails->title)
                ...
                <tr>
                  ...
                  <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $bookdetails->publicationdate)->format('d/m/Y') }}</td>
                </tr>
                @endif
              </tbody>
            </table>
  ...
  <section class="related__articals__section mb-5">
    <div class="container">
      <div class="row g-5">
        ...
        <a href="{{ route('book_details',$res->url)}}">
              <img src="{{ asset('storage/book_image/'.$res->book_image) }}" alt="Ad Image" style="height:400px;width:350px;">
        </a>
        </div>
        @endforeach
