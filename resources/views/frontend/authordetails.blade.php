    ...
    <div class="container">
        ...
        <div
            ...
            <div class="author__profile__banner__content">
                <h2 class="fs-1 fw-bold mb-4 author__name">{{$users->name}}</h2>
                <ul class="social__links [ d-flex align-items-center gap-2 ]">
                    <li><a href="{{$users->instagram}} " target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                    <li><a href="{{$users->twitter}}" target="_blank"><i class="fa-brands fa-twitter"></i></a></li>
                    <li><a href="{{$users->you_tube}}" target="_blank"><i class="fa-brands fa-youtube"></i></a></li>
                </ul>
                <p class="author__discription mb-0">
        ...
        <div class="author__profile__container  [ d-flex flex-column mb-3 ]">
            <div class="content__block" >
                <div class="content__block__text [ d-flex gap-md-5 gap-3 mobile-flex-wrap ]">
                    <p style="word-break: break-word;"> {!! Str::words(strip_tags($users->about_us)) !!}</p>
                </div>
            </div>
