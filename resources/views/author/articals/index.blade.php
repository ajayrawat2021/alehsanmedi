...
<a href="javascript:void(0)" class="edit-artical text-dark mr-2" artical_id="{{ $artical->id }}" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
$.ajax({
url: `{{ URL::to('author/manage-artical/${id}') }}`,
type: "DELETE",
dataType: "json",
...
$.ajax({
url: "{{ URL::to('author/manage-artical/create') }}",
type: "GET",
dataType: "json",
success: function(result) {
if (result.success) {
...
$.ajax({
url: "{{ URL::to('author/manage-artical') }}",
type: 'POST',
processData: false,
contentType: false,
dataType: 'json',
...
$.ajax({
url: `{{ URL::to('author/manage-artical/${id}/edit') }}`,
type: "get",
dataType: "json",
success: function(result) {
if (result.success) {
...
$.ajax({
url: `{{ URL::to('author/manage-artical/${artical_id}') }}`,
type: 'POST',
processData: false,
contentType: false,
dataType: 'json',
